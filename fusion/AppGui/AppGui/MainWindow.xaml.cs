...
namespace AppGui
{
    ...
    public partial class MainWindow : Window
    {
        ...
        string dir_music = Environment.CurrentDirectory.Replace("AppGui\\bin\\Debug", "playlist.xspf");
        ...
        public MainWindow()
        {
            ...
            IPEndPoint socketAddress = new IPEndPoint(IPAddress.Parse("127.0.0.1"), 39525);
        ...
        private void MmiC_Message(object sender, MmiEventArgs e)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                switch ((string)json.recognized[0].ToString())
                {
                    ...
                    default:
                        ...
                        string vol_value = (string)json.recognized[0].ToString();
                        if (Int16.Parse(vol_value) <= 512)
                        {
                            Send(vlcRcSocket, "volume " + vol_value);
                        }
            ...
            string s1 = (string)json.recognized[1].Reaplace("_", " ");
